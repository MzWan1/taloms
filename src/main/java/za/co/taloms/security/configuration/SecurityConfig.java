...
public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http)
                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/authorities", "/authorities/**")
                                                .hasAnyRole("ADMIN", "CHIEF")
                                                .requestMatchers("/api/authorities", "/api/authorities/**")
                                                .hasAnyRole("ADMIN", "CHIEF")
                                                ...
                                                // Staff-only operational pages - ROLE_USER cannot read/modify PTOs,
                                                // parcels, etc.
                                                .requestMatchers("/ptos/**", "/parcels/**", "/gis/**", "/documents/**")
                                                .hasAnyRole("ADMIN", "CHIEF", "HEADSMAN")
                                                .requestMatchers("/api/ptos/**", "/api/parcels/**", "/api/gis/**",
                                                                "/api/documents/**")
                                                .hasAnyRole("ADMIN", "CHIEF", "HEADSMAN")
        ...
        @Bean
        public org.springframework.boot.web.servlet.FilterRegistrationBean<za.co.taloms.common.resiliency.ApiProtectionFilter> apiProtectionFilterRegistration(
                        za.co.taloms.common.resiliency.ApiProtectionFilter filter) {
                org.springframework.boot.web.servlet.FilterRegistrationBean<za.co.taloms.common.resiliency.ApiProtectionFilter> registration = new org.springframework.boot.web.servlet.FilterRegistrationBean<>(
                                filter);
        ...
        @Bean
        public org.springframework.boot.web.servlet.FilterRegistrationBean<za.co.taloms.security.presentation.JwtAuthenticationFilter> jwtAuthenticationFilterRegistration(
                        za.co.taloms.security.presentation.JwtAuthenticationFilter filter) {
                org.springframework.boot.web.servlet.FilterRegistrationBean<za.co.taloms.security.presentation.JwtAuthenticationFilter> registration = new org.springframework.boot.web.servlet.FilterRegistrationBean<>(
                                filter);
                registration.setEnabled(false);
                return registration;
        }
        ...
        @Bean
        public org.springframework.boot.web.servlet.FilterRegistrationBean<za.co.taloms.company.presentation.CompanyApiKeyAuthenticationFilter> companyApiKeyFilterRegistration(
                        za.co.taloms.company.presentation.CompanyApiKeyAuthenticationFilter filter) {
                org.springframework.boot.web.servlet.FilterRegistrationBean<za.co.taloms.company.presentation.CompanyApiKeyAuthenticationFilter> registration = new org.springframework.boot.web.servlet.FilterRegistrationBean<>(
                                filter);
                registration.setEnabled(false);
                return registration;
        }
